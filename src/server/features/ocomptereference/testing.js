...
const { getocomptreferences$}=require('./ocomptreferenceRepository').toinit();
...
const getoreportdetail$ = getocomptreferences$;


/*
getcallbackdata(function(err,data){
   if(err) {
     console.log(err);
   }
